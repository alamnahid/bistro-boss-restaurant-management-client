        ...
        <div className="flex">
            <div className="w-[20rem] min-h-screen bg-[#D1A054] pt-12 px-8">
                ...
                <ul className="menu w-full px-0 mt-16">
                    {
                        isAdmin ? <>
                        <li><NavLink className="uppercase font-bold cin flex justify-start items-center text-base" to="/dashboard/cart"><FaHome className="text-2xl"/> Admin Home</NavLink></li>
