...
const AdminHome = () => {
    ...
    return (
        <div className="lg:mx-[5%] w-full">
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-20">

                <div style={{background: "linear-gradient(90deg, #BB34F5 0%, #FCDBFF 100%)"}} className="w-full h-[15.3rem] rounded-xl flex justify-center items-center gap-4">
                    <img src={wallet} alt="" />
...
{/* 2  */}
                ...
                <div style={{background: "linear-gradient(90deg, #D3A256 0%, #FDE8C0 100%)"}} className="w-full h-[15.3rem] rounded-xl flex justify-center items-center gap-4">
                ...
                <div style={{background: "linear-gradient(90deg, #FE4880 0%, #FECDE9 100%)"}} className="w-full h-[15.3rem]  rounded-xl flex justify-center items-center gap-4">
                    <img src={chef} alt="" />
                    <div className="flex flex-col ">
                ...
                <div style={{background: "linear-gradient(90deg, #6AAEFF 0%, #B6F7FF 100%)"}} className="w-full h-[15.3rem]  rounded-xl flex justify-center items-center gap-4">
                    <img src={truck} alt="" />
                    <div className="flex flex-col ">
